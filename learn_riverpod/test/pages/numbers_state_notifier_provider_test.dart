...
void main() {
  ...
  When [numbersStateNotifierProvider] is pressed
  Then the value [NumbersStateNotifierProvider] page is displayed and the list length is equal to 0
  ...
  ''', (tester) async {
    ...
    final button = find.byKey(ValueKey("numbersStateNotifierProvider"));
    // ACT
    await tester.tap(button);
    await tester.pumpAndSettle();
    // ASSERT
    expect(find.byType(NumbersStateNotifierProvider), findsOneWidget);
